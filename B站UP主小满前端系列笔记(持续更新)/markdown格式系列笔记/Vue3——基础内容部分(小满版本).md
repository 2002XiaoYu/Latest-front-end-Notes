...
<img src=".\xmzs-images\image-20221001030134810.png" alt="image-20221001030134810" style="zoom:50%;" />
...
![image-20221001031307642](.\xmzs-images\image-20221001031307642.png)

![image-20221001031601936](.\xmzs-images\image-20221001031601936.png)
...
![image-20221226232858145](.\xmzs-images\image-20221226232858145.png)
...
![image-20221227024614768](.\xmzs-images\image-20221227024614768.png)![image-20221227024650122](.\xmzs-images\image-20221227024650122.png)
...
![image-20221231162001284](.\xmzs-images\image-20221231162001284.png)

![image-20221231184348742](.\xmzs-images\image-20221231184348742.png)

### 没有key的diff算法

> 一共3步
>
> <img src=".\xmzs-images\image-20221231164920117.png" alt="image-20221231164920117" style="zoom:67%;" />
>
> 1. 无key，patch的时候会替换
> 2. 新增
> 3. 删除
...
![image-20221001094826076](.\xmzs-images\image-20221001094826076.png)

- 推荐类型比较复杂的时候方便自定义

![image-20221001094922141](.\xmzs-images\image-20221001094922141.png)

- 或者什么都不要，让编辑器自己推导

![image-20221001095054253](.\xmzs-images\image-20221001095054253.png)

这里要响应改变值的话，要记得加.value，因为Proxy是在.value中的

<img src=".\xmzs-images\image-20221001095226462.png" alt="image-20221001095226462" style="zoom:50%;" />
...
1. <img src=".\xmzs-images\image-20221001111117720.png" alt="image-20221001111117720" style="zoom:33%;" />打开这个能够让我们观察value方便一点，控制台点一下就行，少点一下。就是格式化了，e f系列跟reactive系列都可以使用
...
<img src=".\xmzs-images\image-20221118090908299.png" alt="image-20221118090908299" style="zoom:47%;" />
...
<img src=".\xmzs-images\image-20221118215901847.png" alt="image-20221118215901847" style="zoom:50%;" />
...
<img src=".\xmzs-images\image-20221118220127745.png" alt="image-20221118220127745" style="zoom:67%;" />
...
![image-20230425133245664](.\xmzs-images\image-20230425133245664.png)
...
![image-20230425134213521](.\xmzs-images\image-20230425134213521.png)
...
![image-20221019001010912](.\xmzs-images\image-20221019001010912.png)
...
![image-20221019001900761](.\xmzs-images\image-20221019001900761.png)
...
<img src=".\xmzs-images\image-20221019002148260.png" alt="image-20221019002148260" style="zoom:50%;" /> 通过点击按钮  <img src="https://xingqiu-tuchuang-1256524210.cos.ap-shanghai.myqcloud.com/925/image-20221019002210245.png" alt="image-20221019002210245" style="zoom:50%;" />
...
<img src=".\xmzs-images\image-20221119035843986.png" alt="image-20221119035843986" style="zoom:67%;" />
...
<img src=".\xmzs-images\image-20221019005124778.png" alt="image-20221019005124778" style="zoom:70%;" />
...
<img src=".\xmzs-images\image-20221021030819712.png" alt="image-20221021030819712" style="zoom:50%;" />

3. 如果type是teleport组件 会执行 process方法

   > 如果是teleport元素的话，会调用process这个方法

   <img src=".\xmzs-images\image-20221021030950416.png" alt="image-20221021030950416" style="zoom:70%;" />
   ...
   4. 点进去这个process方法，主要能够看到process还有remove
      ...
      <img src=".\xmzs-images\image-20221021031704707.png" alt="image-20221021031704707" style="zoom:67%;" />

   5. 重点部分——target

      ![image-20221021032013460](.\xmzs-images\image-20221021032013460.png)

      我们进入这个resolveTarget内部看看源码是怎么做的(他有两个参数，一个是N2.pops。另一个是query selector)

      ![image-20221021032531449](.\xmzs-images\image-20221021032531449.png)
      ...
      <img src=".\xmzs-images\image-20221021033108244.png" alt="image-20221021033106919" style="zoom:87%;" />

      第一步先挂上子节点，然后有一个if判断disabled，要么在原先的地方挂载，要么在target目标(新的目标位置)挂载。上面的disabled true false就是通过这个判断去控制挂载的位置

   6. ![image-20221021033802585](.\xmzs-images\image-20221021033802585.png)
   ...
   7. **移走操作**：
      ...
      ![image-20221021034341599](.\xmzs-images\image-20221021034341599.png)

   8. **删除逻辑**

      ![image-20221021034510139](.\xmzs-images\image-20221021034510139.png)
...
展示Array.apply的区别：相对于new Array而言，一个是空属性，一个却能默认存放undefined<img src=".\xmzs-images\image-20221022022918006.png" alt="image-20221022022918006" style="zoom:50%;" />

随机排列效果图：

<img src=".\xmzs-images\image-20221022025921945.png" alt="image-20221022025921945" style="zoom:50%;" />
...
<img src=".\xmzs-images\image-20221022034628429.png" alt="image-20221022034628429" style="zoom:50%;" />
...
<img src=".\xmzs-images\image-20221023171319315.png" alt="image-20221023171319315" style="zoom:50%;" />
...
**成功展示**![image-20221121012230783](.\xmzs-images\image-20221121012230783.png)
...
![image-20221121013400899](.\xmzs-images\image-20221121013400899.png)
...
![image-20221121013418369](.\xmzs-images\image-20221121013418369.png)
...
效果展示![image-20221121015035504](.\xmzs-images\image-20221121015035504.png)
...
效果展示![image-20221121015533308](.\xmzs-images\image-20221121015533308.png)
...
效果展示：![image-20221121020242652](.\xmzs-images\image-20221121020242652.png)
...
<img src=".\xmzs-images\image-20221121030607399.png" alt="image-20221121030607399" style="zoom:50%;" />

![image-20221204034704194](.\xmzs-images\image-20221204034704194.png)
...
![image-20221204034914317](.\xmzs-images\image-20221204034914317.png)
...
![image-20221204040819930](.\xmzs-images\image-20221204040819930.png)
...
![image-20221204042320424](.\xmzs-images\image-20221204042320424.png)
...
> 主要功能如下：
>
> ![image-20221204043403171](.\xmzs-images\image-20221204043403171.png)
...
>
> 不报错的效果![image-20221204051141373](.\xmzs-images\image-20221204051141373.png)
...
![image-20221204052626766](.\xmzs-images\image-20221204052626766.png)

- 页面内容正常渲染

<img src=".\xmzs-images\image-20221204052738605.png" alt="image-20221204052738605" style="zoom:50%;" />
...
>
> <img src=".\xmzs-images\image-20221025080212131.png" alt="image-20221025080212131" style="zoom:67%;" />
...
<img src=".\xmzs-images\image-20221025081006020.png" alt="image-20221025081006020" style="zoom:80%;" />
...
![image-20221027001014931](.\xmzs-images\image-20221027001014931.png)
...
<img src=".\xmzs-images\image-20221027010659745.png" alt="image-20221027010659745" style="zoom:67%;" />
...
![image-20221202202833703](.\xmzs-images\image-20221202202833703.png)
...
<img src=".\xmzs-images\image-20221028000901611.png" alt="image-20221028000901611" style="zoom:67%;" />
...
![image-20221028001204072](.\xmzs-images\image-20221028001204072.png)
...
<img src=".\xmzs-images\image-20221028001422281.png" alt="image-20221028001422281" style="zoom:50%;" />
...
> ```
>
> ![image-20230106115531991](.\xmzs-images\image-20230106115531991.png)
...
<img src=".\xmzs-images\image-20221028010957470.png" alt="image-20221028010957470" style="zoom:50%;" />

>  如果不写 Scoped 就没问题
>
> 原因就是 Scoped 搞的鬼 他在进行 PostCss 转化的时候把元素选择器默认放在了最后

<img src=".\xmzs-images\image-20221028011031260.png" alt="image-20221028011031260" style="zoom:67%;" />
...
<img src="https://xingqiu-tuchuang-1256524210.cos.ap-shanghai.myqcloud.com/925/image-20221028011055850.png" alt="image-20221028011055850" style="zoom:50%;" /><img src=".\xmzs-images\image-20230106120442069.png" alt="image-20230106120442069" style="zoom:67%;" />
...
>     - script
>     - style
>   - ![image-20230106121235367](.\xmzs-images\image-20230106121235367.png)
...
<img src=".\xmzs-images\image-20221028012502463.png" alt="image-20221028012502463" style="zoom:50%;" />
...
<img src=".\xmzs-images\image-20221028012602471.png" alt="image-20221028012602471" style="zoom:60%;" />
...
<img src=".\xmzs-images\image-20221028165506768.png" alt="image-20221028165506768" style="zoom:35%;" /><img src="https://xingqiu-tuchuang-1256524210.cos.ap-shanghai.myqcloud.com/xiaoyu925/image-20221028165529086.png" alt="image-20221028165529086" style="zoom:40%;" />
...
<img src=".\xmzs-images\image-20221028174817630.png" alt="image-20221028174817630" style="zoom:67%;" />
...
<img src=".\xmzs-images\image-20221029011414486.png" alt="image-20221029011414486" style="zoom:50%;" />
...
<img src=".\xmzs-images\image-20221029011505040.png" alt="image-20221029011505040" style="zoom:67%;" />

> 安装完后通过终端输入java或者javac，看能不能正常显示，可以的话就是安装成功了

<img src=".\xmzs-images\image-20221029012007573.png" alt="image-20221029012007573" style="zoom:50%;" />
...
<img src="https://xingqiu-tuchuang-1256524210.cos.ap-shanghai.myqcloud.com/xiaoyu925/image-20221029012119703.png" alt="image-20221029012119703" style="zoom:40%;" /><img src=".\xmzs-images\image-20221029012139135.png" alt="image-20221029012139135" style="zoom:40%;" />

> 语言会 java 选 java 会别的就选别的

<img src=".\xmzs-images\image-20221029012224076.png" alt="image-20221029012224076" style="zoom:50%;" />

> 等待加载完成

<img src=".\xmzs-images\image-20221029012249002.png" alt="image-20221029012249002" style="zoom:67%;" />

> 打开之后可以创建一个虚拟机 

<img src=".\xmzs-images\image-20221029012308994.png" alt="image-20221029012308994" style="zoom:67%;" />

> 创建完成之后就可以运行安卓项目

<img src=".\xmzs-images\image-20221029012334927.png" alt="image-20221029012334927" style="zoom:50%;" />

>  其实就是一个虚拟手机

<img src=".\xmzs-images\image-20221029012412260.png" alt="image-20221029012412260" style="zoom:67%;" />

> 切换成代码模式

<img src=".\xmzs-images\image-20221029012434685.png" alt="image-20221029012434685" style="zoom:50%;" />
...
<img src=".\xmzs-images\image-20221029012546483.png" alt="image-20221029012546483" style="zoom:50%;" />

> webView 就和小程序的 webView 基本一样 套网页的
>
> **match_parent 表示让当前控件的大小和父布局的大小一样，也就是让父布局来决定当前控件的大小**

<img src=".\xmzs-images\image-20221029012637496.png" alt="image-20221029012637496" style="zoom:50%;" />
...
<img src=".\xmzs-images\image-20221029012717584.png" alt="image-20221029012717584" style="zoom:67%;" />

> 配置权限

<img src=".\xmzs-images\image-20221029012741080.png" alt="image-20221029012741080" style="zoom:67%;" />
...
![image-20221029012803227](.\xmzs-images\image-20221029012803227.png)
...
![image-20221029012833653](.\xmzs-images\image-20221029012833653.png)
...
![image-20221029014539491](.\xmzs-images\image-20221029014539491.png)
...
<img src=".\xmzs-images\image-20221029014635847.png" alt="image-20221029014635847" style="zoom:67%;" />
...
![image-20221029014714339](.\xmzs-images\image-20221029014714339.png)
...
![image-20221029014857392](.\xmzs-images\image-20221029014857392.png)
...
<img src=".\xmzs-images\image-20221029024147767.png" alt="image-20221029024147767" style="zoom:50%;" />

<img src=".\xmzs-images\image-20221029024230035.png" alt="image-20221029024230035" style="zoom:67%;" />
...
<img src=".\xmzs-images\image-20221029024326972.png" alt="image-20221029024326972" style="zoom:50%;" />
...
<img src=".\xmzs-images\image-20221029024413185.png" alt="image-20221029024413185" style="zoom:100%;" />
...
![image-20221029024448813](.\xmzs-images\image-20221029024448813.png)
...
![image-20221029024620786](.\xmzs-images\image-20221029024620786.png)

> 上面是小满的效果，我的不知道为什么内容跟窗口分离了，就是白屏了，在后面会有讲解到，需要使用到Debugtron工具(自行下载)
>
> 问题贼多，由于我还有其他事情，目前也不写这个桌面程序，所以就看着，不继续踩坑了

![image-20221029145302924](.\xmzs-images\image-20221029145302924.png)
...
<img src=".\xmzs-images\image-20221029024754088.png" alt="image-20221029024754088" style="zoom:67%;" />

> 安装成功后的样子

![image-20221029024822686](.\xmzs-images\image-20221029024822686.png)
...
![image-20221029024900534](.\xmzs-images\image-20221029024900534.png)

> 加上之后

![image-20221029024916311](.\xmzs-images\image-20221029024916311.png)
...
<img src=".\xmzs-images\image-20221029154223821.png" alt="image-20221029154223821" style="zoom:70%;" />
...
![image-20221029165142677](.\xmzs-images\image-20221029165142677.png)

###  修改启动命令

> 在 package json 配置 --mode env 文件名称。修改后就能生效

<img src=".\xmzs-images\image-20221029165222746.png" alt="image-20221029165222746" style="zoom:67%;" />
...
<img src=".\xmzs-images\image-20221029165253714.png" alt="image-20221029165253714" style="zoom:67%;" />
...
![image-20221029165331964](.\xmzs-images\image-20221029165331964.png)
...
![image-20221029165357165](.\xmzs-images\image-20221029165357165.png)

![image-20221029165409004](.\xmzs-images\image-20221029165409004.png)

### **如果想在 vite.config.ts 使用环境变量**

![image-20221029165428545](.\xmzs-images\image-20221029165428545.png)
...
![image-20221118041311032](.\xmzs-images\image-20221118041311032.png)

发现是没有问题的

![image-20221118041336382](.\xmzs-images\image-20221118041336382.png)

> 以上是打包后的效果，让我们使用npm run dev启动项目试一试
>
> 正常启动，莫得问题，从路径中我们能发现他们的不同之处

![image-20221118041528445](.\xmzs-images\image-20221118041528445.png)

>  本地启动项目是支持热更新的，也就是你编辑器里的东西一改，页面同步进行改动

![image-20221118041507642](.\xmzs-images\image-20221118041507642.png)
...
- 需要安装插件
  ...
  - 重新运行项目，然后就可以了(这里记得css文件不要放到views文件夹去，他们两个挨太近了，我给放错位置，报错显示找不到哈哈)
    ...
    <img src=".\xmzs-images\image-20221118053037140.png" alt="image-20221118053037140" style="zoom:67%;" />

  ![image-20221118052907487](.\xmzs-images\image-20221118052907487.png)
...
- 成功解决问题后，我们尝试一下在App.vue中写下TS代码尝试效果
  ...
  ![image-20221118060659343](.\xmzs-images\image-20221118060659343.png)
...
![image-20221118061813271](.\xmzs-images\image-20221118061813271.png)
...
![image-20221029171146467](.\xmzs-images\image-20221029171146467.png)

![image-20221029171227572](.\xmzs-images\image-20221029171227572.png)
...
![image-20221029171552764](.\xmzs-images\image-20221029171552764.png)
...
<img src=".\xmzs-images\image-20221029171732821.png" alt="image-20221029171732821" style="zoom:67%;" />

<img src=".\xmzs-images\image-20221029171744045.png" alt="image-20221029171744045" style="zoom:67%;" />
...
![image-20221029171836454](.\xmzs-images\image-20221029171836454.png)
...
![image-20221029172012528](.\xmzs-images\image-20221029172012528.png)

### 防抖节流

> 同样 VueUse 也是集成了

![image-20221029172042033](.\xmzs-images\image-20221029172042590.png)
...
![image-20221029174408114](.\xmzs-images\image-20221029174408114.png)
...
![image-20221029175604096](.\xmzs-images\image-20221029175604096.png)

![image-20221029175614603](.\xmzs-images\image-20221029175614603.png)
...
![image-20221203034619148](.\xmzs-images\image-20221203034619148.png)
...
![image-20221203034721309](.\xmzs-images\image-20221203034721309.png)
...
![image-20221203035020508](.\xmzs-images\image-20221203035020508.png)
